...
if("FALSE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/intelligentrobotics/rokon/src/main)
  set(main_DEVEL_PREFIX /home/intelligentrobotics/rokon/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/intelligentrobotics/rokon/install)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/intelligentrobotics/rokon/install/${idir}'.  Ask the maintainer 'Your Name <you@example.com>' to fix it.")
    endif()
