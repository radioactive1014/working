...
{	
	...
	//red_cornerX.push_back(result_red[0]);
	//green_cornerX.push_back(result_green[0]);
	//blue_cornerX.push_back(result_blue[0]);

	//red_cornerY.push_back(result_red[1]);
	//green_cornerY.push_back(result_green[1]);
	//blue_cornerY.push_back(result_blue[1]);
